...
public class CropImageView extends ImageView {
    ...
    private void drawOverlay(Canvas canvas) {
        ...
        L.e("left == "+mImageRect.left+"   top==="+mImageRect.top+"right == "+mImageRect.right+"   botttom==="+mImageRect.bottom+" viewwidth = "+mViewWidth+",viewheight = "+mViewHeight);
    ...
    private Rect calcCropRect(int originalImageWidth, int originalImageHeight) {
        ...
        L.e("left = "+Math.max(left, 0)+",top = "+Math.max(top, 0)+",right ="+Math.min(right, imageW)+", bottom = "+Math.min(bottom, imageH));
    ...
    private Bitmap scaleBitmapIfNeeded(Bitmap cropped) {
        ...
        L.e("outwidth = "+outWidth+",outheight = "+outHeight);
            ...
            public void run() {
                ...
                try {
                    final Bitmap sampledBitmap = Utils.decodeSampledBitmapFromUri(getContext(),
                            mSourceUri,
                            requestSize);
                    mInputImageWidth = Utils.sInputImageWidth;//TODO
    ...
    public Bitmap getCroppedBitmap(int width,int height) {
        ...
        L.e("width == "+source.getWidth()+"   heiight==="+source.getHeight());
    ...
    public void startCrop(Uri saveUri, CropCallback cropCallback, SaveCallback saveCallback) {
        ...
        mExecutor.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (mSourceUri == null) {
                    cropped = getCroppedBitmap(100,100);
                }
                // Use file for crop
                else {
